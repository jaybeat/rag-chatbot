...
class AIGenerator:
    """Handles interactions with Kimi API (OpenAI-compatible) for generating responses"""
...
"""
    ...
    def generate_response(self, query: str,
        ...
        if tools:
            api_params["tools"] = [{"type": "function", "function": tool} for tool in tools]
    ...
    def _handle_tool_execution(self, initial_response, base_params: Dict[str, Any], tool_manager):
        ...
        for tool_call in assistant_message.tool_calls:
            ...
            tool_result = tool_manager.execute_tool(tool_name, **tool_arguments)
